      ...
      chai
        ...
        .end(function (err, res) {
          ...
          assert.property(
            res.body,
            "stockData",
            "Response must include 'stockData' property"
          );
          assert.property(
            res.body.stockData,
            "stock",
            "stockData must include 'stock' property"
          );
          assert.property(
            res.body.stockData,
            "likes",
            "stockData must include 'likes' property"
          );
          assert.property(
            res.body.stockData,
            "price",
            "stockData must include 'price' property"
          );
      ...
      chai
        ...
        .end(function (err, res) {
          ...
          assert.property(
            data[0],
            "rel_likes",
            "stockData must include 'rel_likes' property"
          );
          assert.property(
            data[0],
            "price",
      ...
      chai
        ...
        .end((err, res) => {
          ...
          assert.property(
            res.body,
            "success",
            "Response must have 'success' property"
          );
          assert.property(
            res.body,
            "error",
    ...
    test("no duplicate stocks with when two are passed", function (done) {
      chai
        ...
        .end((err, res) => {
          ...
          assert.equal(
            res.body.error,
            "Stocks symbols must be unique when comparing"
          );
          done();
        });
    });
